...
from FallenRobot.modules.sql.karma_mongo import (alpha_to_int, get_karma,
                                   get_karmas, int_to_alpha, update_karma)   
from FallenRobot.modules.sql.karma_mongo import is_karma_on, karma_off, karma_on

karma_positive_group = 3
karma_negative_group = 4

regex_upvote = r"^((?i)\+|\+\+|\+1|thx|tnx|ty|thank you|thanx|thanks|pro|piro|cool|good|👍)$"
regex_downvote = r"^(\-|\-\-|\-1|👎|bsdk)$"
